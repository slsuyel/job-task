      ...
      <div className="bg-white p-6 rounded-md shadow-md">
        ...
        {paymentChannel && (
          <div className="bg-green-100 p-4 rounded-md mb-4">
            ...
            <p className="mt-2">
              উপকারভোগী অ্যাকাউন্ট নম্বর: <strong>{paymentOptions[paymentChannel]}</strong>
            </p>
            <p className="mt-2">পরিমাণ: <strong>{price} টাকা</strong></p>
            <p className="mt-2">ধাপ ১: {paymentChannel} এর মাধ্যমে অর্থ স্থানান্তর করুন।</p>
            <p className="mt-2">ধাপ ২: অর্থপ্রদানের পরে আপনার <strong>লেনদেন আইডি</strong> অনুলিপি করুন।</p>
          </div>
        )}

        <p className="text-sm text-gray-500 mt-4">
          দয়া করে নিশ্চিত করুন যে স্থানান্তর করা ওয়ালেট নম্বর রিচার্জ নম্বরের সাথে সামঞ্জস্যপূর্ণ। যদি আপনি ভুল নম্বরে রিচার্জ করেন, তাহলে আপনি নিজেই ক্ষতির জন্য দায়ী হবেন।
        </p>
        ...
        <form onSubmit={handleSubmit} className="mt-6">
          ...
          <button className="bg-blue-500 w-full text-white px-4 py-2 rounded-md hover:bg-blue-600" type="submit">
            জমা দিন
          </button>
        </form>
        <br />
